...
export const Navbar = ({homePage}:NavbarProps)=>{
    ...
    return(
     <nav className={`flex absolute top-0 left-0 py-5 px-4 right-0 border-b-[1px] md:mx-8 md:px-0 border-Gray-200 z-30 items-center text-PureWhite-100 justify-between ${(productDetailPage||checkoutPage)?"bg-PureBlack-100 h-auto static lg:w-full lg:mx-0 lg:px-30":"lg:mx-30"}`}> 
