...
const SummaryItem = ({product,gap="gap-x-7",prodImgSize="w-15 h-13"}:SummaryItemProps) => {
  return (
    <div className={`flex lg:gap-x-4 text-xs md:text-sm ${gap}`}>
        <ProductImage alt="Checkout product image" src={product.smallImage || ""} wrapperStyle={prodImgSize} className="" />
