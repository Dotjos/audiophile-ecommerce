...
const SummaryItem = ({product}:SummaryItemProps) => {
  return (
    <div className="flex text-xs md:text-sm gap-x-7">
        <ProductImage alt="Checkout product image" src={product.smallImage || ""} wrapperStyle="w-15 h-13" className="w-11 h-11 rounded-md"/>
