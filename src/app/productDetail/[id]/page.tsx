  ...
  return (
    <div className="px-4 md:px-8 md:py-6 lg:px-30 lg:py-13">
      ...
      <div>
        ...
        <ProductImage src={product?.image || ''} wrapperStyle="md:w-1/3 h-60 lg:w-4/9 md:h-110 lg:h-90" className=" md:h-auto" alt={product?.name || 'Product Image'} />
        <div className="md:w-7/12 gap-3 lg:w-4/9 flex flex-col md:justify-center md:gap-5 lg:gap-1">
        {product.isNew&&<h2 className="text-xs tracking-[5px] md:tracking-[10px] font-light text-BurntSienna-100 mt-2">NEW PRODUCT</h2>}
